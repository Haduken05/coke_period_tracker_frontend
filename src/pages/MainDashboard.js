...
const Dashboard = () => {
    ...
    return (
        ...
        <div style={{ padding: '40px', fontFamily: 'sans-serif', textAlign: 'center' }}>
            ...
            <Link to="/login" style={{ display: 'inline-block', marginTop: '30px', color: '#3498db', textDecoration: 'none', fontWeight: 'bold' }}>
                Back to Login
            </Link>

            <Link to="/sandbox" style={{ display: 'inline-block', marginTop: '30px', marginLeft: '20px', color: '#3498db', textDecoration: 'none', fontWeight: 'bold' }}>
                Go to Style Sandbox
            </Link>
